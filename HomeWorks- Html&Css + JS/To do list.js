...
deleteButton.style.setProperty('color', 'white')
    ...
    child.style.setProperty('border','6px solid lime')
...
child.style.setProperty('border','6px solid red')
